...
def generate_go_term_list(onto_path,namespace):
    onto=obonet.read_obo(onto_path)
    if namespace=='bp':
        terms = [term for term in onto.nodes if onto.nodes[term]['namespace'] == 'biological_process']
    elif namespace=='cc':
        terms = [term for term in onto.nodes if onto.nodes[term]['namespace'] == 'cellular_component']
    elif namespace=='mf':
        terms = [term for term in onto.nodes if onto.nodes[term]['namespace'] == 'molecular_function']
