...
def main(aspect,deepgo2,fastdataloader,protein_embedding_path,go_embedding_path,seed,temperature):
    ...
    learning_rate = profile.get('learning_rate', 1e-3)
    early_stopping_patience = profile.get('early_stopping_patience', 8)
    ...
    for epoch in range(epoch_num):
        ...
        with torch.no_grad():
            ...
            print(f'Epoch {epoch}: Loss - {train_loss:.4f} Valid loss - {valid_loss:.4f}, AUC - {roc_auc:.4f}')
